	...
	<div class='formcontainer'>  
		  <div class="form-group form-custom">	
			...
			<select name="vk_code" id="select-native-1" class='form-control' onChange="vk_check()">
			    ...
			    <option value="VK4">배우자출산휴가</option>
			    <option value="VK5">경조사휴가</option>
			    <option value="VK6">생리휴가</option>
		  ...
		  <div class="form-group form-custom">
		    ...
		    <input type="date"  class="form-control" name="va_start_date" id="va_start_date" onChange="calcDate()" value="">
		   </div>
		   <div id="date_end_valid" class="form-group form-custom">
		    ...
		    <input type="date"  class="form-control" name="va_end_date" id="va_end_date" onChange="calcDate()" value="">
		   </div>
		    <div class="form-group form-custom">
		    ...
		    <input type="text"  class="form-control" name="va_day" id="va_days_num" value="" readonly>
		   </div>
		   <div class="form-group form-custom">
		  ...
		  <div class="form-group form-custom">
		    ...
		    <textarea name="va_reason" class="form-control" id="textarea-1" placeholder='휴가 사유를 입력하세요.'></textarea>
		  </div>
		  <div class="form-group form-custom" style="text-align:center;">
		  	<button type="button" id="vs_submit" class="btn btn-secondary">신청 하기</button>
		  </div>
		</div>
</div>
	 ...
	 // 휴가 날짜수 구하기
	   ...
	   $("#vs_submit").on("click",function(){
		...
		if(cnt == 3){
			...
			$.ajax({ 
				url: "/vacation/submit", // 클라이언트가 HTTP 요청을 보낼 서버의 URL 주소 
